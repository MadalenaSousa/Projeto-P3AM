...
<main class="wrapper">
    ...
    <div class="ocupa-16-coluna wrapper sub-wrapper">
        ...
        <div class="ocupa-5-coluna">
            ...
            monte, a procurar-me com os olhos… Depois, sobe timidamente as escadas… Ela está aterrorizada por ir sozinha,
            oh, quão aterrorizada! Está pálida como o neve, treme, caminha com quem vai para a sua execução, mas vai, ainda
            sem hesitar, determinada.
            <br><br>
            Aparentemente, resolveu ter a certeza: será que vai ouvir as palavras maravilhosas, doces, não estando eu com
            ela? Vejo-a, pálida, com a boca aberta de terror, a sentar-se no trenó, a fechar os olhos, despedindo-se para
            sempre da terra, vejo-a partir… Zzzz — zumbem os patins.
            <br><br>
            Não sei se Nadenka ouviu as palavras… Só a vejo a sair do trenó, fraca, abalada. Pela cara dela, não saberá se
    ...
    <div class="ocupa-16-coluna wrapper sub-wrapper">
        <div class="ocupa-5-coluna">
            Uma vez, antes da minha partida, uns dois dias antes, estava eu sentado ao crepúsculo num jardinzinho, separado
            do quintal de Nadia por um muro alto espetado de pregos… Ainda estava frio, por baixo do estrume ainda havia
            neve, as árvores ainda estavam despidas mas já cheirava a Primavera, as gralhas preparavam-se para ir dormir,
            gritavam alto. Aproximo-me do muro e fico algum tempo a espreitar por uma fenda. Vejo como a Nadenka sai para
            o sol da rua com um olhar triste voltado para o céu… O vento da primavera sopra-lhe diretamente no rosto pálido,
            amargurado… Lembra-lhe o vento que outrora nós rugia no mente e como ela ouvia aquelas palavrinhas, o rosto dela
            torna-se triste, muito triste, pela face desliza-lhe uma lágrima…
            <br><br>
            A pobre rapariga estende as duas mãos como que a pedir que o vento lhe traga outra vez aquelas palavras… Então,
            fico a espera que o vento sopre para dizer a meia voz:
            <br><br>
            — Amo-te Nadia!
            <br><br>
            O que acontece com Nadenka, meu Deus! Solta um grito, abre-se num sorriso amplo e estende as mãos ao encontro do
            vento, alegre, feliz, tão bonita.
            <br><br>
            Eu vou fazer as malas…
        </div>
        <div class="ocupa-2-coluna">
            <h1 id="DataMorte">1904</h1>
        </div>
        <img class="ocupa-6-coluna " id="pensador" src="imagens/fotos/pensador.jpg" >
    </div>

    <!-- Página 9 -->
    <div class="ocupa-16-coluna wrapper sub-wrapper">
        <div class="ocupa-5-coluna">
            Isto foi há muito tempo. Nadenka já está casada, casaram-na ou casou de livre vontade — tanto faz — com o
            secretário do concelho da nobreza e já tem três filhos. O tempo em que íamos escorregar de trenó juntos e o
            vento trazia aquele “Amo-te Nadenka!” é agora a mais feliz e mais bonita memória da sua vida…
            <br><br>
            Mas agora que sou mais velho, não compreendo porque lhe dizia aquelas palavras, porque é que eu joguei aquele
            jogo...
        </div>
        <div class="ocupa-10-coluna" style="grid-row: 9/ span 5">
